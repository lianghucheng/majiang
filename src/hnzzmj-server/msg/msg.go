...
func init() {
	...
	Processor.Register(&C2S_SetHNZZConfig{})
	Processor.Register(&C2S_StartHNZZMatching{})
	...
	Processor.Register(&C2S_GetHNZZIOSProductList{})
	Processor.Register(&C2S_GetHNZZAndroidProductList{})
	...
	Processor.Register(&S2C_DecideHNZZJoker{})
	...
	Processor.Register(&S2C_HNZZRoundResult{})
	Processor.Register(&S2C_HNZZTotalResult{})
	...
	Processor.Register(&S2C_UpdateHNZZTotalScore{})
	Processor.Register(&S2C_TransferRoomCard{})
	Processor.Register(&S2C_UpdateWinTiles{})
	Processor.Register(&S2C_SetHNZZConfig{})
	...
	Processor.Register(&S2C_HNZZIOSProductList{})
	Processor.Register(&S2C_HNZZAndroidProductList{})
	Processor.Register(&S2C_HNZZCatchBird{})
...
type S2C_ActionDisbandRoom struct {
	...
	PlayerDisbandInfos []mahjong.HNZZPlayerDisbandInfo // 解散信息
